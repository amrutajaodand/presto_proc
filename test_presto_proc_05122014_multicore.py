...
Modification: parallelizing the process used in presto proces srunning 
"""
#################################################################################
...
N_cores = 8     #number of cores that can be used 
Ncore_max = 8   #Upper limit on core usage 
#################################################################################
#importing modules
import numpy as np
...
src_dir = "/lustre/pulsar/scratch/ajaodand/GBT14B-036_AMXPs/test"

##Initialise the files to store the results of the processing 
#create folder for a given date
outpath= "test_presto_proc_05122014_multicore"
...
h.close()
"""
#Forming a distributed ddplan for a given number of cores 
...
#############################################################
##function to parallelise the prepsubband 
