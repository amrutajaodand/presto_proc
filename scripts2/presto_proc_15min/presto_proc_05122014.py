...
outpath= "/lustre/pulsar/scratch/ajaodand/GBT14B-036_AMXPs/results_15min"
...
print "ls %s/*.dat | xargs -n 1 accelsearch -zmax 100 > %s/accelsearch_data_%s"%(results_dir,results_dir,key)
